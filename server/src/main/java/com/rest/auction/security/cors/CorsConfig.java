package com.rest.auction.security.cors;
...
//not extending WebMvcConfigurerAdapter or other Spring Security class
    ...
    public FilterRegistrationBean customCorsFilter() {
        ...
        config.addAllowedOrigin("https://airporttaxi.azurewebsites.net");
        config.addAllowedOrigin("http://10.0.11.14:8082");
        config.addAllowedOrigin("http://127.0.0.1:8082");
        config.addAllowedOrigin("http://localhost:8082");
        config.addAllowedOrigin("http://20.197.56.162:8082");
